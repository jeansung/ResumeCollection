...
% Update new DSL project 
% Update your clinic description
% Actually delete all the old stuff? Getting ready for the real world!! 
\begin{document}
...
%\begin{flushleft}
%{\textbf{AWARDS \& HONORS}} 
% Harvey S. Mudd Merit Award (Scholarship)
% \vb Dean's List \\
% Superior Academic Performance
% \vb Commendation Letter, Department of Chemistry 
%\end{flushleft} 
...
%\customtab Preparing and teaching weekly lessons on CS fundamentals for 15 middle school students\\
...
% idTech Summer
%\textbf{Java and Scratch Programming Instructor}, iD Tech Summer Camps \rightAlign \textbf{Aug. 2014}\\
