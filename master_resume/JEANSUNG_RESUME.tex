...
Advanced Algorithms (Fall 2015)
\vb Artificial Intelligence (Fall 2015) 
\vb Software Development \\
Digital Electronics \& Comp. Engineering
\vb Data Structures \& Program Development
\vb Programming Practicum \\
Domain Specific Languages
\vb Image Processing  
\vb Linear Algebra \& Differential Equations II
%\vb Multivariable Calculus  \\
...
\textbf{Project Manager}, Laserfiche-HMC Clinic \rightAlign Fall 2015 \\ 
\customtab Team leader of corporate sponsored capstone project: Simple Real Time Data Analysis System \\ 
...
% Leadership 
\flushleft {\textbf{LEADERSHIP} Girls Who Code Lead Instructor  \vb Blood Drive Coordinator \vb Tech Summer Camp Instructor 
% Fun
